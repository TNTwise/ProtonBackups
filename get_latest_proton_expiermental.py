...
with open(home_dir+'/Downloads/'+proton_ver+'/'+proton_ver+"/compatibilitytool.vdf", "w") as f:
...
with open(home_dir+'/Downloads/'+proton_ver+'/'+proton_ver+"/proton", "r") as f:
    for line in f:
...
with open(home_dir+'/Downloads/'+proton_ver+'/'+proton_ver+"/proton", "w") as f:
